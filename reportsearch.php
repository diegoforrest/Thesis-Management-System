...
<script nomodule src="https://unpkg.com/ionicons@5.5.2/dist/ionicons/ionicons.js"></script>
    <title>my.DLSU-D Manuscript</title>
    <style>
        body {
    ...
    height: auto; /* Ensures the body takes up the full viewport height */
...
.search-bar {
    display: flex;
    align-items: center;
    justify-content: center; /* Aligns the search bar content to the right */
    width: 100%;  /* Ensures the search bar takes up the full width of the container */
}
...
<nav>
    ...
    <div class="search-bar">
            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($searchResults as $row): ?>
                        <tr>
                            <td>
                                <a href="downloadfile.php?titleId=<?php echo urlencode($row['TITLE_ID']); ?>">
                                    <button class="view-chapter-btn">Download Manuscript</button>
                                </a>
                            </td>
        ...
        <?php else: ?>
            <p style= "color: red"class="no-results">No found search yet.</p>
        <?php endif; ?>
    </div>
<!-- Footer -->
<div class="footer">
